...
public class LearningMaterial1 : MonoBehaviour
{
    ...
    {   
        ...
        rewardClaimed = PlayerPrefsCheckClaimed.GetBool("Learning1RewardClaimed", false);
        if (!rewardClaimed)
        {
    ...
    {   
        ...
        if (s4.style.display == DisplayStyle.Flex)
        {
